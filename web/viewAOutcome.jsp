<%-- 
    Document   : viewAOutcome
    Created on : 07 Jun 2024, 10:05:55 PM
    Author     : Jeanette
--%>
...
<html>
    <head>
        ...
        <title>acceptable temperatures Page</title>
    </head>
    <body>
        <h1>Acceptable temperatures!</h1>
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td>
                 ...
                 <tr>
                <td>List of temperatures statuses:</td>
